 ...
 *  \~english
 *
 *  @brief ZPL Command Data Generate Class.
 *
 */
 ...
 *  @param location     location of font file.
 *  @param fontName     font name.
 *  @param extension    font file extension name.
 *
 */
 ...
 *
 */
- (void)DG_DownloadGraphicsWithStoreDevice:(PTZplFileLocation)storeDevice
                                 imageName:(NSString *)imageName
                                 extension:(NSString *)extension
