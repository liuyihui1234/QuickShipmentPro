...
#import "ZYMidLineView.h"

#define CORNER_WIDTH FitSize(16)
#define CLIP_ARC_DIAMETER FitSize(240)

@interface ZYClipImageView ()

@property (nonatomic, strong) UIImageView *clipImageView; /**< 被裁剪的图片*/
@property (nonatomic, strong) ZYClipAreaView *clipAreaView; /**< 裁剪区域*/
...
//四条中间线
@property (nonatomic, strong) ZYMidLineView *topMidLine;
@property (nonatomic, strong) ZYMidLineView *leftMidLine;
@property (nonatomic, strong) ZYMidLineView *bottomMidLine;
@property (nonatomic, strong) ZYMidLineView *rightMidLine;
...
@implementation ZYClipImageView
...
{
    ZYMidLineView *midLine = (ZYMidLineView *)panGesture.view;
    CGPoint movePoint = [panGesture translationInView:self];
...
- (ZYClipAreaView *)clipAreaView
{
    if(!_clipAreaView)
    {
        _clipAreaView = [[ZYClipAreaView alloc] initWithFrame:self.bounds];
...
- (ZYMidLineView *)topMidLine
{
    if(!_topMidLine)
    {
        _topMidLine = [[ZYMidLineView alloc] initWithWidth:MID_LINE_WIDTH height:MID_LINE_INVISIBLE type:MidLineViewTypeTop];
...
- (ZYMidLineView *)leftMidLine
{
    if(!_leftMidLine)
    {
        _leftMidLine = [[ZYMidLineView alloc] initWithWidth:MID_LINE_INVISIBLE height:MID_LINE_WIDTH type:MidLineViewTypeLeft];
...
- (ZYMidLineView *)bottomMidLine
{
    if(!_bottomMidLine)
    {
        _bottomMidLine = [[ZYMidLineView alloc] initWithWidth:MID_LINE_WIDTH height:MID_LINE_INVISIBLE type:MidLineViewTypeBottom];
...
- (ZYMidLineView *)rightMidLine
{
    if(!_rightMidLine)
    {
        _rightMidLine = [[ZYMidLineView alloc] initWithWidth:MID_LINE_INVISIBLE height:MID_LINE_WIDTH type:MidLineViewTypeRight];
